...
# async def deep_translator_service(text, source_lang, target_lang):
#     """DeepTranslator service"""
#     try:
#         return DeeplTranslator(source=source_lang, target=target_lang, timeout=10).translate(text)
#     except Exception as e:
...
# async def libre_translate(text, source_lang, target_lang):
#     """LibreTranslate service"""
#     try:
#         # Assuming LibreTranslate server is running locally or configured
#         url = "http://localhost:5000/translate"  # Adjust if needed
#         payload = {
#             "q": text,
#             "source": source_lang,
#             "target": target_lang
...
# async def translate_between_languages(text, source_lang, target_lang):
#     """Translate between any two languages"""
#     if source_lang == target_lang:
#         return text
#     return await robust_translate(text, source_lang, target_lang)
